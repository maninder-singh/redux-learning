...
module.exports.applyMiddleware = (...middleawares) => {
    return createStore => {
        ...
        return (reducers,preLoadInitial,enhancer) => {
            ...
            let chains = middleawares.map(middleware => {
            ...
            return {...store,dispatch} /* store with dispatch set to first middleware action method  */;
        }
    }
};